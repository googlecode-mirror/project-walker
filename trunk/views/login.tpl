...
<div id="main" align="center">
	...
	<div id="v2ex" align="left">
		...
		<hr size="1" color="#EEE" style="color: #EEE; background-color: #EEE; height: 1px; border: 0;" />		<table width="100%" cellpadding="5" cellspacing="0" class="login_form_t">
			...
			<tr>
				<td width="80"></td>
				<td valign="middle"><input type="image" src="/images/login.gif" alt="登录" /></td>
			</tr>
<input type="hidden" value="http://www.v2ex.com/" name="return" />			</form>
		</table>
	</div>
	
	<div id="bottom" align="center">

	&copy; 2006-2007 <a href="http://www.v2ex.com/" target="_self">V2EX</a>
	</div>
